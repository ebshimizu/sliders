...
with tf.Graph().as_default():
    #filename_queue = tf.train.string_input_producer(['C:/Users/falindrith/Dropbox/Documents/research/sliders_project/test_images/canonical/shimmer/a2_sm.png'])
    ...
    np.save(outputname, np.reshape(feats, -1))
